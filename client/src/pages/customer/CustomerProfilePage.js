...
import { useAuth } from '../../context/AuthContext'; // Assuming useAuth provides a way to update user, or user state updates automatically
...
const CustomerProfilePage = () => {
    ...
    useEffect(() => {
        if (user) {
            ...
            setEmail(user.email);
            // Set initial image preview to current user's image
    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            ...
            setImagePreview(user?.imageUrl || null); // Revert to current user image if no file selected
        }
    };
    ...
    const handleProfileUpdate = async (e) => {
        ...
        try {
            ...
            // Assuming the backend returns the updated user object, or you have a way to refresh it
            if (updateUser) { // If updateUser function exists in AuthContext
                updateUser(res.data); // Update the user in AuthContext
            }
                ...
                <div style={profileCardStyle}>
                    <div style={cardHeaderContentStyle}>
                        ...
                        <img
                            ...
                            style={customerProfileImageStyle} // Renamed for clarity
                        />
                    </div>
                    {!isEditing ? (
